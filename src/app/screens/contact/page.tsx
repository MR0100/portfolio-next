      ...
      children={
        <div className="container m-auto p-[42px]">
          <div className="flex flex-col gap-[24px]">
              ...
              <div className="lg:basis-3/5 flex flex-col gap-[48px]">
                <div className="flex flex-col gap-[12px]">
                  ...
                  <p className="text-[17px]">
                    ...
                    with experience 🏗️ building high-quality applications? Look
                    no further!
                    <br />
                    ...
                    satisfaction😌. I am well-versed in mobile app guidelines
                    and pay close attention to design layouts, ensuring{" "}
            ...
            <p className="text-[17px]">
              I am <b>Top Rated Plus Developer</b> providing my service on
              Upwork for 5+ years with have <b>100% Job Success Score</b>. It
              verifies my identity as a responsible developer who always finish
              the Job with 100% Client Satisfaction.
            </p>
